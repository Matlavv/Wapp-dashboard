  ...
  return (
    <div className="p-6 md:p-12 space-y-8">
      <header className="mb-16 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <h1 className="text-3xl md:text-4xl font-black tracking-tight mb-2">Logs Cleanup</h1>
      ...
      <div className="space-y-6">
        {logs?.map((log) => (
          <div key={log.id} className="bg-card border border-border/50 p-6 md:p-8 rounded-3xl shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 group">
            <div className="flex items-center gap-6">
              <div className="w-12 h-12 rounded-2xl bg-secondary/50 border border-border/50 flex items-center justify-center text-foreground group-hover:bg-foreground group-hover:text-background transition-all duration-500 shrink-0">
            ...
            <div className="flex items-center gap-12 text-center w-full md:w-auto justify-between md:justify-end pl-18 md:pl-0">
