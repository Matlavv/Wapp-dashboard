...
import { ArrowRight, Bell, Database, Globe, Key, Shield, User } from 'lucide-react';
                ...
                <div className="flex justify-between items-end">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm font-medium italic">
                            Paramétrez votre environnement et votre profil
                            d&apos;administrateur.
                        </p>
                    </div>
                </div>
                ...
                <section className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <form
                            ...
                            className="bg-card border border-border/50 p-8 rounded-3xl shadow-sm hover:shadow-md transition-all"
                        >
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] font-medium text-muted-foreground opacity-60">
                                        Gérer les politiques d&apos;accès aux tables.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="p-8 flex items-center justify-between hover:bg-secondary/20 transition-all cursor-pointer">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-[11px] font-medium text-muted-foreground opacity-60">
                                        Recevoir une notification lors d&apos;un échec de cron.
                                    </p>
                                </div>
                            </div>
                            <ArrowRight className="w-4 h-4 text-muted-foreground opacity-30" />
